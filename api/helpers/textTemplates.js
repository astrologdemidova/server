exports.textTemplates = {
    ...
    '002': [
        ...
        '.',
        'ВАЖНО: перед тем, как начать выполнять действия, указанные в инструкции - зайдите на сайт j108.ru и войдите в личный кабинет.',
        'ЛОГИН: yana.demidova.95@inbox.ru',
        'ПАРОЛЬ: xPcJxzFT',
        '(Пароль не меняйте, ничего не сохраняйте)',
        '.',
        'P.S. Надеюсь вы верно указали почту? Если да, то все письма для вас уже там.',
        '.',
        'P.P.S.Если у вас не открывается файл, значит ваше устройство не поддерживает данный формат (.zip)',
        'попробуйте другое устройство или установите программу для чтения архивов.',
        'Если вы находитесь в сети Украины, пожалуйста воспользуйтесь VPN, чтобы скачать файл',
        '.',
        'С любовью, Яна🤍'],
    '003': [
        'Произошла ошибка или приз уже выигран:(',
    ...
    '005': [
        ...
        'Шооок!?',
        '.',
        'P.S. Я свяжусь с вами и мы обсудим детали. Либо, если не терпится (и я вас в этом понимаю) - можете написать мне в Инстаграм : https://www.instagram.com/astrolog_demidova/',
        'С любовью, Яна🤍'],
    '006': [
        'Ураааа! Поздравляю, вы выиграли приз, стоимостью 2000 рублей:',
...
exports.textTemplatesBackup = {
    '001': [
        ...
        'Либо, если не терпится (и я вас в этом понимаю) - можете написать мне в Инстаграм : https://www.instagram.com/astrolog_demidova/',
        '.',
        'С любовью, Яна🤍'],
    '002': [
        'Ураааа! Поздравляю, вы выиграли приз, стоимостью 2000 рублей:',
